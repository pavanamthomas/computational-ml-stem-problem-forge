...
This is a personal research repository. The useful unit of work is a limitation,
a failed specification, or a tighter ground-truth check.
...
Authoring a problem: `docs/problem_authoring_standard.md`.  
Ground truth: `docs/ground_truth_protocol.md`.  
